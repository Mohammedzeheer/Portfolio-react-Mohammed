      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2  text-white-100`}>
            <span className="sm:hidden">MERN Stack Developer</span>
          </p>
          ...
          <div className="flex">
            <div
              onClick={() =>
                window.open("https://github.com/Mohammedzeheer", "_blank")
              }
            ...
            <div
              onClick={() =>
                window.open("https://linkedin.com/in/mohammedzeheer/", "_blank")
              }
            ...
            <div
              onClick={() =>
                window.open("https://www.instagram.com/zaheer_.zak/", "_blank")
              }
              className="ml-3 mt-3 black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
